...
#Este progrma resuelve el problema 1 de la tarea, se puede cambiar la matriz en la siguiente linea
...
tol=1e-8
iterJacobi=1000000
#El primer paso hace el método de la potencia algunas veces, por ejemplo 10. Debe ser mayor a 2 para el $x0$ que consideramos
iterPotencia=10
x0=zeros(Float64,m,n).+1

@time P,D=iteracionSubespaciosPotencia(A,m,n,maxIter,tol,iterJacobi,iterPotencia,x0)
