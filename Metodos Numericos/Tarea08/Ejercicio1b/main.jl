...
n=6 #Hacemos minimos cuadrados para aproximación con polinomio de orden 6 de f1 y f2 con 5 puntos
m=5
z=sort(2*rand(m).-1)
y1=(25*z.^2 .+ 1).^-1
y2=abs.(z)-z/2 - z.^2
...
m=100 #Hacemos minimos cuadrados para aproximación con polinomio de orden 6 de f1 y f2 con 100 puntos
z=sort(2*rand(m).-1)
y1=(25*z.^2 .+ 1).^-1
y2=abs.(z)-z/2 - z.^2
...
m=1000 #Hacemos minimos cuadrados para aproximación con polinomio de orden 6 de f1 y f2 con 1000 puntos
z=sort(2*rand(m).-1)
y1=(25*z.^2 .+ 1).^-1
y2=abs.(z)-z/2 - z.^2
